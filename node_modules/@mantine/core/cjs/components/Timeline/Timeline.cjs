...
const Timeline = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Timeline_context.TimelineProvider, { value: { getStyles } }, /* @__PURE__ */ React.createElement(Box.Box, { ...getStyles("root"), mod: [{ align }, mod], ref, ...others }, items));
});
