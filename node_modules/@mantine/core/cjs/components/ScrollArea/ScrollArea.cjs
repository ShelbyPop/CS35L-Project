...
const ScrollAreaAutosize = factory.factory((props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Box.Box, { ...others, ref, style: [{ display: "flex", overflow: "auto" }, style] }, /* @__PURE__ */ React.createElement(Box.Box, { style: { display: "flex", flexDirection: "column", flex: 1 } }, /* @__PURE__ */ React.createElement(
    ScrollArea,
    {
      classNames,
      styles,
