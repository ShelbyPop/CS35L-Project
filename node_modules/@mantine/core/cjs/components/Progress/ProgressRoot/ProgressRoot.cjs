...
const ProgressRoot = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Progress_context.ProgressProvider, { value: { getStyles, autoContrast } }, /* @__PURE__ */ React.createElement(Box.Box, { ref, ...getStyles("root"), ...others }));
});
