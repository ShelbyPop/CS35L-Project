...
const Avatar = polymorphicFactory.polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    error ? /* @__PURE__ */ React.createElement("span", { ...getStyles("placeholder"), title: alt }, children || /* @__PURE__ */ React.createElement(AvatarPlaceholderIcon.AvatarPlaceholderIcon, null)) : /* @__PURE__ */ React.createElement(
      "img",
      {
        ...imageProps,
        ...getStyles("image"),
